-- Применить новую версию distribute_advance_payment
-- Алгоритм: работаем по месячному периоду, как UI
-- ============================================
-- 
-- ИНСТРУКЦИЯ:
-- 1. Скопируй весь этот файл в Supabase SQL Editor
-- 2. Выполни одним запросом
-- 3. После применения протестируй сценарий:
--    - Логопед: начисление 3500, первая оплата 2000, вторая оплата 800
--    - При второй оплате система должна снова начать с Логопеда и погасить оставшийся долг 1500
-- ============================================

-- На всякий случай удаляем старую версию функции без параметра даты,
-- чтобы не было неоднозначности по имени
