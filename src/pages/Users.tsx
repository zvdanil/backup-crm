...
export default function Users() {
  ...
  return (
    <>
      <PageHeader
        title="Користувачі"
        description={`${profiles.length} користувачів`}
      />
      <div className="p-8">
        <div className="mb-6 flex items-center justify-between gap-4">
          <div className="rounded-xl border border-border bg-card p-4 flex-1">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <Switch
                checked={authDebugEnabled}
                onCheckedChange={handleAuthDebugToggle}
              />
            </div>
          </div>
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        createUserForm.setValue("role", value as UserRole)
                      }
                      disabled={createUser.isPending}
                    >
                      <SelectTrigger>
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        createUserForm.setValue("isActive", checked)
                      }
                      disabled={createUser.isPending}
                    />
                    <Label
