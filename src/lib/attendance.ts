...
/**
 * Format a Date object to YYYY-MM-DD string using local timezone (not UTC)
 * This ensures dates are consistent regardless of timezone offset
 */
...
/**
 * Get the first day of a month as YYYY-MM-DD string in local timezone
 */
...
/**
 * Get the last day of a month as YYYY-MM-DD string in local timezone
 */
