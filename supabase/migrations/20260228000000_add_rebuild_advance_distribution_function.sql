-- ============================================
-- Rebuild advance distribution for a student/account
-- Deletes existing advance_payment transactions and recomputes
-- distribution from all payment transactions in chronological order
-- ============================================
