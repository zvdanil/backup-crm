...
BEGIN
  ...
  -- Сохраняем начальный авансовый баланс
...
'Пересчитывает авансовый баланс для существующих income/expense транзакций. Списывает с авансового баланса сумму всех начислений (income - expense), созданных после последнего платежа.';
