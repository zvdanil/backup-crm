-- ============================================
-- Версия 4: distribute_advance_payment с обработкой возвратов
-- Логика:
-- 1. Сначала находим активности с положительным балансом (возвраты за питание)
-- 2. Добавляем эти суммы на авансовый счёт
-- 3. Потом обрабатываем активности с долгами как обычно
-- ============================================
